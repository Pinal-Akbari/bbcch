<?php require_once('my-database.php') ?>

<!doctype html>
<html lang="en">


<!-- Mirrored from codervent.com/rocker/demo/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jun 2024 05:12:35 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="assets/images/logo-icon.png" class="logo-icon" alt="logo icon">BBHHC
				</div>
				<div>
			...
			<ul class="metismenu" id="menu">
                ...
                <li>
					...
					<ul>
						<li> <a href="all-user-list.php"><i class='bx bx-radio-circle'></i>User List</a></li>
						<li> <a href="pending-user-list.php"><i class='bx bx-radio-circle'></i>Pending User</a></li>
						<li> <a href="all-business-list.php"><i class='bx bx-radio-circle'></i>Business List</a></li>
					</ul>
				</li>
                <li>
					<a href="javascript:;" class="has-arrow">
					...
					<ul>
						<li> <a href="show-my-business.php"><i class='bx bx-radio-circle'></i>Show Business</a></li>
						<li> <a href="add-new-business.php"><i class='bx bx-radio-circle'></i>Add New Business</a></li>
					</ul>
				</li>
				<li>
				...
				<li>
					<a href="all-business-list.php">
						<div class="parent-icon"><i class=''></i>
						</div>
						<div class="menu-title">Business List</div>
					</a>
